...
interface PresidencialDetailClientProps {
  presidencial: CandidatoCompleto;
...
export default function PresidencialDetailClient({
  presidencial,
  dynastyData,
  familiarMap,
  eoroHistorial = [],
  eoroEvaluaciones = [],
}: PresidencialDetailClientProps) {
    ...
    <div className="min-h-screen bg-[#f5f5f0]">
      <div className="bg-white/80 backdrop-blur-sm border-b border-gray-200/60 px-6 py-4">
        <div className="mx-auto max-w-[1400px] flex items-center justify-between">
          <nav className="flex items-center gap-2 text-sm text-gray-400">
            <Link href="/presidenciales" className="hover:text-gray-700 transition-colors">
              Presidenciales 2026
            </Link>
      ...
      <div className="mx-auto max-w-[1400px] px-6 py-8">
        <div className="flex flex-col gap-6 lg:flex-row lg:items-end lg:justify-between">
          ...
          <div className="flex items-center gap-3">
            <StatPill
              value={historial_candidaturas.length > 0 ? (() => {
                const eoroTotal = presidencial.eoro_score?.score_total;
                const displayScore = eoroTotal != null ? eoroTotal : (score.total > 0 ? score.total : null);
                return displayScore != null ? String(displayScore) : "—";
              })() : "—"}
              label={(() => { 
                const eoroTotal = presidencial.eoro_score?.score_total;
                const displayScore = eoroTotal != null ? eoroTotal : (score.total > 0 ? score.total : null);
                return displayScore != null ? getEoroScoreLabel(displayScore) : "Score"; 
              })()}
              color="green"
            />
            <StatPill
        ...
        <div className="mt-8 grid gap-6 lg:grid-cols-[320px_1fr]">
          <div className="space-y-5">
            <div className="rounded-3xl bg-white p-5 shadow-sm border border-gray-100">
              ...
              <div className="flex items-center gap-3 mb-5">
                ...
                <div className="min-w-0">
                  ...
                  <p className="text-xs text-gray-400">Presidencia 2026</p>
                </div>
              </div>

              <div className="space-y-3">
                <InfoRow label="Partido" value={partido.nombre} />
                <InfoRow label="Cargo" value="Presidente de la Republica" />
                {persona.departamento_origen && (
            ...
            {presidencial.eoro_score ? (
              <EoroScoreCard score={presidencial.eoro_score} />
            ) : (
              <div className="rounded-3xl bg-white p-5 shadow-sm border border-gray-100">
                <p className="text-xs font-medium text-gray-400 uppercase tracking-wide mb-4">
                  Eoro Score
          ...
          <div className="space-y-6">
                ...
                {alertas.slice(0, 3).map((alerta) => {
                  ...
                  return (
                    <div key={alerta.id} className={cn("rounded-3xl p-5 relative overflow-hidden", c.bg)}>
                      <div className="absolute -right-4 -bottom-4 text-7xl font-bold opacity-[0.07]">!</div>
            ...
            {activeSection === "trayectoria" && (
              <div className="space-y-5">
                <div className="rounded-3xl bg-white p-6 shadow-sm border border-gray-100">
                  <h2 className="text-lg font-semibold text-gray-800 mb-5">Cargos publicos</h2>
                ...
                <div className="rounded-3xl bg-white p-6 shadow-sm border border-gray-100">
                  <h2 className="text-lg font-semibold text-gray-800 mb-5">Historial electoral</h2>
                  {historial_candidaturas.length === 0 ? (
            ...
            {activeSection === "patrimonio" && (
              <div className="space-y-5">
                {declaraciones.length === 0 ? (
                  ...
                  <>
                    <div className="rounded-3xl bg-white p-6 shadow-sm border border-gray-100">
                      <h2 className="text-lg font-semibold text-gray-800 mb-5">Evolucion patrimonial</h2>
                      <div className="overflow-x-auto">
                        <table className="w-full">
                          <thead>
                            <tr className="text-left text-xs text-gray-400 border-b border-gray-100">
